  ...
  return (
    <div>
      ...
      <div className='row'>
            ...
            <div className='row'>
            <p style={{ paddingTop: '40px', fontWeight: 'bold', fontSize: '12px'}}>Home - CHWs / Promotores / Personal and Professional Development</p>
            </div>
  <div>
    <div className='row'>
        <div className='col-7'>
...
<div className="row" style={{ paddingTop: '20px'}}>
    ...
    <BorderButton text={'Chart'}></BorderButton>
    <BorderButton text={'Comic'}></BorderButton>
    <BorderButton text={'Diagram'}></BorderButton>
    <BorderButton text={'Graph'}></BorderButton>
    <BorderButton text={'Infographic '}></BorderButton>
    <BorderButton text={'Illustration '}></BorderButton>
    <BorderButton text={'Map'}></BorderButton>
    <BorderButton text={'Photograph'}></BorderButton>
</div>
<div className='row'>
<p style={{ paddingTop: '30px', paddingBottom: '30px',fontWeight: 'bold', fontSize: '12px', color: '#707070'}}>47 results</p>
</div>
                <div className="row">
...
export default PersProfessDevelop;
